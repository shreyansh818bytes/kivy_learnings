...
from kivy_tutorials.Chat_App import socket_client
...
class ScrollableLabel(ScrollView):
    ...
    # this is to fix the window resizing issue
...
class ConnectPage(GridLayout):
    def __init__(self, **kwargs):
        ...
        self.join.bind(on_press=self.join_btn)
        self.add_widget(self.join)

    def join_btn(self, instance):
        port = self.port.text
        ip = self.ip.text
    ...
    def connect(self, _):
        ...
        chat_app.screen_manger.current = "Chat"
